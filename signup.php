...
if (isset($_POST['submit'])) {
	...
	$password2 = $_POST['password2'];
		...
		if ($my_form->validate_fields('firstname,lastname,username,password')) { // comma delimited list of the required form fields
...
?>
			...
			<input type="email" name="email" value="<?php echo $_POST['email']; ?>" class="form-control" placeholder="Email"/></p>
